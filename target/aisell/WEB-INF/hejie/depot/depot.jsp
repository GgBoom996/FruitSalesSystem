...
<head>
    ...
    <script type="text/javascript" src="/plugins/model/depot.js"></script>
</head>
<body>
        ...
        <form id="ff" method="post">
            ...
            <table cellpadding="5">
                    ...
                    <td><input class="easyui-textbox" type="text" name="name"  ></input></td>
                             ...
                             <tr>
                    <td>maxcapacity:</td>
                    <td><input class="easyui-textbox" type="text" name="maxcapacity"  ></input></td>
                </tr>
                             <tr>
                    <td>currentcapacity:</td>
                    <td><input class="easyui-textbox" type="text" name="currentcapacity"  ></input></td>
                </tr>
                             <tr>
                    <td>totalamount:</td>
        ...
        <thead>
            <tr>
                 <th data-options="field:'id',checkbox:true,width:'1%'">ID</th>
                                ...
                                <th data-options="field:'maxCapacity',width:100,align:'center'">最大容量</th>
                                <th data-options="field:'currentCapacity',width:100,align:'center'">现在库存</th>
